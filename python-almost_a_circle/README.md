Python - Almost a circle
 This directory covers Unit testings and how to implement it in large projects, hwo to serialize and deserialize a class, hwo to write and read a JSON file, *args and **kwargs what they are and how to use them, and how to handle named arguments in a function.
